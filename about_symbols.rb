...
class AboutSymbols < Neo::Koan
  def test_symbols_are_symbols
    symbol = :ruby
    assert_equal _, symbol.is_a?(Symbol)
  end
  ...
  def test_symbols_can_be_compared
    ...
    assert_equal _, symbol1 == symbol2
    assert_equal _, symbol1 == symbol3
  end
  ...
  def test_identical_symbols_are_a_single_internal_object
    ...
    assert_equal _, symbol1           == symbol2
    assert_equal _, symbol1.object_id == symbol2.object_id
  end

  def test_method_names_become_symbols
    symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }
    assert_equal _, symbols_as_strings.include?("test_method_names_become_symbols")
  end
